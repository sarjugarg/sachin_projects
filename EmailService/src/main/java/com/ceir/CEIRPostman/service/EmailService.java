...
public class EmailService implements Runnable {
     ...
     public void run() {
          ...
          SystemConfigurationDb fromEmail = systemConfigRepoImpl.getDataByTag("Email_Username");    // meri email 
          SystemConfigurationDb emailRetryCount = systemConfigRepoImpl.getDataByTag("Email_Retry_Count");    // retring
